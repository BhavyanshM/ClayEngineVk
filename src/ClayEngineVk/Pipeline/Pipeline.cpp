...
namespace ClayEngineVk
{
                                          ...
                                          const PipelineConfigInfo& configInfo)
    {
        ...
        viewportInfo.pScissors = &configInfo.scissors;
    ...
    PipelineConfigInfo Pipeline::DefaultPipelineConfigInfo(uint32_t width, uint32_t height)
    {
        ...
        // Convert from glPosition to screen coordinates
        ...
        // Used for chopping the screen pixels
        configInfo.scissors.offset = {0, 0};
        configInfo.scissors.extent = {width, height};

        // Configures how the triangles are rendered on the screen (fill, line thickness, depth bias, culling)
        ...
        // Configures how the multisampling aliasing is done
        ...
        // Configures how the color blending is done
        ...
        // Configures the depth and stencil testing
